...
class Enu:
    ...
    def toEcef(self, originLla):
        ...
        x = (-sinLon * self.east - sinLat * cosLon * self.north + cosLat * cosLon * self.up +
             originEcef.x)
        y = (cosLon * self.east - sinLat * sinLon * self.north + cosLat * sinLon * self.up +
             originEcef.y)
    ...
    def __str__(self):
        return "%.2fm East, %.2fm North, %.2fm Up" % (
            self.east,
            self.north,
            self.up,
        )
